...
- [Proxying API Requests in Development](#proxying-api-requests-in-development)
  - ["Invalid Host NavBar" Errors After Configuring Proxy](#invalid-host-header-errors-after-configuring-proxy)
...
### "Invalid Host NavBar" Errors After Configuring Proxy
